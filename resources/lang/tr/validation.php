...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'summary_information' => 'Özet Bilgi',
        'user' => 'Kullanıcı',
        'user_id' => 'Kullanıcı',
        'price' => 'Ücret',
        'status' => 'Durum',
        'price_blog' => 'Blog Fiyatı',
        'price_image' => 'Resim Fiyatı',
        'price_video' => 'Video Fiyatı',
        'role' => 'Rol',
        'roles' => 'Roller',
        'permissions' => 'Yetkiler',
        'url' => 'Adres',
        'image_url' => 'Resim Adresi',
        'video_url' => 'Video Adresi',
        'social_url' => 'Sosyal Medya Adresi',
        'upload_type' => 'Yükleme Tipi',
        'subject' => 'Konu',
        'message' => 'Mesaj',
        'iban' => 'İban Numarası',
        'bank' => 'Banka Adı',
        'parent_id' => 'Üst Kategori',
        'youtube' => 'Profesyonel Youtube Hesabı',
        'instagram' => 'Profesyonel Instagram Hesabı',
    ],
