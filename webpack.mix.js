...
// Arquito template requirements
mix.copyDirectory('resources/arquito/assets', 'public/assets');
mix.copyDirectory('resources/arquito/favicons', 'public/favicons');
mix.copyDirectory('resources/arquito/img', 'public/img');
